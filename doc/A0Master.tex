...
em que 
\begin{eqnarray}
\bm{{\rm M}}_{nm}^{i}(\bm{{\rm r}})&=&j_p(kr)\bm{{\rm X}}_{nm}(\bm{{\rm \hat{r}}})\\
...
em que
\begin{eqnarray}
\bm{{\rm M}}_{nm}^{s}(\bm{{\rm r}})&=&h_p^{(2)}(kr)\bm{{\rm X}}_{nm}(\bm{{\rm \hat{r}}})\\
...
em que
\begin{eqnarray}
\bm{{\rm M}}_{nm}^{w}(\bm{{\rm r}})&=&j_p(k'r)\bm{{\rm X}}_{nm}(\bm{{\rm \hat{r}}})\\
...
=
-\left(j_p'(kr)+\frac{j_p(kr)}{kr}\right)\bm{{\rm V}}_{nm}(\bm{{\rm \hat{r}}})-
\sqrt{p(p+1)}\frac{j_p(kr)}{kr}\bm{{\rm Y}}_{nm}(\bm{{\rm \hat{r}}})
\end{eqnarray}
então
\begin{eqnarray}
\bm{{\rm\hat{r}}}\times\bm{{\rm M}}_{nm}(\bm{{\rm r}})&=&iu_p(kr)\bm{{\rm V}}_{nm}(\bm{{\rm \hat{r}}})\\
\bm{{\rm\hat{r}}}\times\bm{{\rm N}}_{nm}(\bm{{\rm r}})&=&-i\left(u_p'(kr)+\frac{u_p(kr)}{kr}\right)\bm{{\rm X}}_{nm}(\bm{{\rm \hat{r}}})
\end{eqnarray}

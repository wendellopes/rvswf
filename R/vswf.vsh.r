...
#-------------------------------------------------------------------------------
   ...
   LMAXE=(lmax+1)*(lmax+3)+1                   # Vector for (lmax+1) - Extended
#-------------------------------------------------------------------------------
...
#                  KmLm,KoLo,KpLM,KmlM,Kolo,Kplm,
                  Ylm=Ylm, #SCALAR SPHERICAL HARMONICS
                  Xm,Xz,Xp, # X VECTOR SPHERICAL HARMONIC
                  Ym,Yz,Yp, # Y VECTOR SPHERICAL HARMONIC
                  Vm,Vz,Vp, # V VECTOR SPHERICAL HARMONIC
